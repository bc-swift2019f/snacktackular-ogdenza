...
class Photo {
    ...
    func saveData(spot: Spot, completed: @escaping (Bool) -> ()) {
        ...
        // create a ref to upload storage to spot.ducmentID's folder (bucket), with the name we created
        ...
        uploadTask.observe(.success) { (snapshot) in
            ...
            // This will either create a new documentUUID or update the existing doc with that name
