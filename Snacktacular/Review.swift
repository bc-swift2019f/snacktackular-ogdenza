...
//  Snacktacular
//
//  Created by Zach Ogden on 11/3/19.
...
class Review {
    ...
    var dictionary: [String: Any] {
        return ["title": title, "text": text, "longitude": rating, "latitude": rating, "reviewerUserID": reviewerUserID, "date": date, "documentID": documentID]
    }
    ...
    func saveData(spot: Spot, completed: @escaping (Bool) -> ()) {
        ...
        if self.documentID != "" {
            ...
            var ref: DocumentReference? = nil // Let Firestore create new document ID
